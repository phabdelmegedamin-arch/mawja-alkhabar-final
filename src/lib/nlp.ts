...
const NEG: Record<string, number> = {
  ...
  'انخفاض':1.5,
  // ── جمل خسارة مركبة ─────────────────────────────────────────
  'تحقق خسارة':4.5,'تحقق خسائر':4.5,
  'حقق خسارة':4.5,'حقق خسائر':4.5,
  'حققت خسارة':4.5,'حققت خسائر':4.5,
  'يحقق خسارة':4.5,'يحقق خسائر':4.5,
  'سجل خسارة':4.5,'سجلت خسارة':4.5,'تسجل خسارة':4.5,
  'سجل خسائر':4.5,'سجلت خسائر':4.5,'تسجل خسائر':4.5,
...
const POS: Record<string, number> = {
  ...
  // أرباح
  'حقق':1.0,'حققت':1.0,'تحقق':1.0,'تحققت':1.0,'تحقيق':1.0,
